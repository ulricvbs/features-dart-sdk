#!/usr/bin/env bash
# https://github.com/devcontainers-community/features/blob/dcc4ae22bc27db3399bb8861d873dd2a843579e3/src/dart/install.sh
# Originally written by https://github.com/eitsupi
